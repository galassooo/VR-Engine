 ...
 */
bool Eng::MultipassRenderer::setupShadowMap(int width, int height) {
...
void Eng::MultipassRenderer::renderTransparentPass()
{
    auto& sm = ShaderManager::getInstance();
 ...
 */
void Eng::MultipassRenderer::renderPass(bool isAdditive, bool useCulling) {
    auto& sm = ShaderManager::getInstance();
...
void Eng::MultipassRenderer::shadowPass(std::shared_ptr <Eng::DirectionalLight>& light) {
    auto& sm = ShaderManager::getInstance();
